...
export const Route = createFileRoute('/honai/revenue-new-sales/')({
...
function RouteComponent() {
    ...
    const { data, isLoading, isRefetching, refetch } = useQuery(trpc.newSales.getRevenueAll.queryOptions({ date }, {
